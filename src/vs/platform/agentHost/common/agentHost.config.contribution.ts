...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'chat.editor.defaultProvider': {
			...
			enumDescriptions: [
				nls.localize('chat.editor.defaultProvider.local', "Use the built-in Dida local chat harness"),
		...
		'chat.editor.localAgent.enabled': {
			type: 'boolean',
			description: nls.localize('chat.editor.localAgent.enabled', "When enabled, shows the Dida local chat harness in the chat picker."),
			default: true,
			tags: ['experimental'],
			experiment: { mode: 'startup' },
		},

...
const fixtureTheme = JSON.stringify({ name: 'Code Light Fixture Theme', type: 'dark', colors: {}, tokenColors: [] });

const themeJsonModules: Record<string, string> = {
	'/extensions/theme-defaults/themes/dark_modern.json': fixtureTheme,
	'/extensions/theme-defaults/themes/dark_plus.json': fixtureTheme,
	'/extensions/theme-defaults/themes/dark_vs.json': fixtureTheme,
	'/extensions/theme-defaults/themes/light_modern.json': fixtureTheme,
	'/extensions/theme-defaults/themes/light_plus.json': fixtureTheme,
	'/extensions/theme-defaults/themes/light_vs.json': fixtureTheme,
};

...
export abstract class ExtHostTaskBase implements ExtHostTaskShape, IExtHostTask {
	...
	constructor(
		...
		// MainThreadTask is removed in this fork: do not register supported
		// executions with the (missing) main thread counterpart.
	}
	...
	public registerTaskSystem(scheme: string, info: tasks.ITaskSystemInfoDTO): void {
		// MainThreadTask is removed in this fork: do not register task systems
		// with the (missing) main thread counterpart.
	}

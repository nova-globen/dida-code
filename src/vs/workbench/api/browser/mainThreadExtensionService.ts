...
import { ExtHostCustomersRegistry, extHostNamedCustomer, IExtHostContext, IInternalExtHostContext } from '../../services/extensions/common/extHostCustomers.js';
...
export class MainThreadExtensionService implements MainThreadExtensionServiceShape {
	...
	constructor(
		...
		// This fork removes several mainThread customers, so only assert the
		// proxy identifiers of customers that are actually registered instead
		// of every identifier in MainContext.
		internalExtHostContext._setAllMainProxyIdentifiers(ExtHostCustomersRegistry.getNamedCustomers().map(([identifier]) => identifier));
	}

 ...
 */
/**
 * Lets an alternative host (this fork's terminal home editor tab) take over
 * the role of the terminal panel for the group service.
 */
export interface ITerminalPanelOverride {
	isVisible(): boolean;
	reveal(focus?: boolean): Promise<void>;
}
...
export interface ITerminalGroupService extends ITerminalInstanceHost {
	...
	/**
	 * When set, showPanel/hidePanel/updateVisibility use this host instead of
	 * the terminal view in the panel.
	 */
	panelOverride: ITerminalPanelOverride | undefined;

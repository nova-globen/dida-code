...
import { supportsTelemetry, ITelemetryAppender, NullAppender, NullEndpointTelemetryService, NullTelemetryService, getPiiPathsFromEnvironment, isInternalTelemetry, isLoggingOnly } from '../../../platform/telemetry/common/telemetryUtils.js';
...
class SharedProcessMain extends Disposable implements IClientConnectionFilter {
	...
	private async initServices(): Promise<IInstantiationService> {
		...
		services.set(ICustomEndpointTelemetryService, new SyncDescriptor(NullEndpointTelemetryService));

...
import { IProxyAuthService } from '../../platform/native/electron-main/auth.js';
...
class NullProxyAuthService implements IProxyAuthService {
	declare readonly _serviceBrand: undefined;

	lookupAuthorization(_authInfo: AuthInfo): Promise<Credentials | undefined> {
...
export class CodeApplication extends Disposable {
	...
	private async initServices(machineId: string, sqmId: string, devDeviceId: string, sharedProcessReady: Promise<MessagePortClient>): Promise<IInstantiationService> {
		...
		// Proxy Auth
		services.set(IProxyAuthService, new SyncDescriptor(NullProxyAuthService));
